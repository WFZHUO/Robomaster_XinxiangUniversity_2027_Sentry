 ...
 */
void Class_Buzzer::Init(float __Frequency, float __Loudness)
{
    htim = &htim12;
 ...
 */
void Class_Buzzer::Play_Note(float __Frequency, uint32_t __Duration_ms, float __Loudness, uint32_t __Gap_ms)
{
    Set_Sound(__Frequency, __Loudness);
    HAL_Delay(__Duration_ms);
